...
import config.PostgresConfigurationHelper
...
class AccountantPostgresTestSpec extends ScalaTestWithActorTestKit(PostgresConfigurationHelper.configWithDBProvider)
