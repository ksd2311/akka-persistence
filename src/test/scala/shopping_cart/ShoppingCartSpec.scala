...
class ShoppingCartSpec extends ScalaTestWithActorTestKit(
  ...
  "The Shopping Cart" should {
    ...
    "keep its state" in {
      ...
      cart ! ShoppingCart.AddItem("apple", 50, probe.ref)
      probe.expectMessage(ShoppingCart.Accepted(ShoppingCart.Summary(Map("foo" -> 42, "apple" -> 50), checkedOut = false)))
      ...
      stateProbe.expectMessage(ShoppingCart.Summary(Map("foo" -> 42, "apple" -> 50), checkedOut = false))
    }
  }
